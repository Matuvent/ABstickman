...
execute store result storage ab wither_skull.x double 0.01 run scoreboard players get @n[tag=ab.reg,type=wither_skull] ab.x
execute store result storage ab wither_skull.y double 0.01 run scoreboard players get @n[tag=ab.reg,type=wither_skull] ab.y
execute store result storage ab wither_skull.z double 0.01 run scoreboard players get @n[tag=ab.reg,type=wither_skull] ab.z

execute as @n[tag=ab.reg,type=wither_skull] run function ab:rod/block/shoot with storage ab wither_skull
#execute as @n[tag=ab.reg,type=wither_skull] run tp @s ^ ^ ^2.5 facing ^ ^ ^3
