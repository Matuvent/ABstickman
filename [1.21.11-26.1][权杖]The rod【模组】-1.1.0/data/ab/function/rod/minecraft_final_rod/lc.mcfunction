...
execute if predicate ab:is_sneaking positioned ^3 ^ ^ run function ab:rod/minecraft/weapon_summon
execute if predicate ab:is_sneaking positioned ^-3 ^ ^ run function ab:rod/minecraft/weapon_summon
execute if predicate ab:is_sneaking run function ab:rod/minecraft/weapon_summon
execute if predicate ab:is_sneaking run return fail
