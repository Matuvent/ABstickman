execute positioned ~ ~-1 ~ as @e[distance=..2.5,type=!#ab:non_mob] positioned ^ ^ ^-10000 unless entity @s[distance=..10000] in ab:darkness run spreadplayers 0.0 0.0 1 100 under 115 false @s
